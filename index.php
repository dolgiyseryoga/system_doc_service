...
<head>
  ...
  <title>СИСТЕМА УСКОРЕНИЯ ДОКУМЕНТАОБОРОТА</title>
    ...
    <div class="container">
      <div class="row animatedParent animateOnce">
        <div class="col-lg-6 col-md-6 col-sm-6">
          <h1>
            Система <span class="shr-color">ускорения</span> документаоборота
          </h1>
          <p>
            Мы экономим Ваше время, предлагая современные решения ускорения
            бизнесс-отчетов. <br />
          </p>
          <a class="btn btn-default" href="#" role="button">Оставить заявку на подключение</a>
          <a class="btn btn-default shr-download-btn" href="#" role="button">Узнать подробнее</a>
        </div>
        <div class="col-lg-6 col-md-6 col-sm-6 shr-dis-none">
          <div class="shr-hero-content-img animated fadeInUpShort slow delay-250" style="display: flex; justify-content: end">
            <img class="hand" src="images/others/hand.png" />
          </div>
        </div>
      </div>
    </div>
