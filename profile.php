    ...
    <div class="container">
        <div class="panel">
            ...
            <div class="panel_buttons">
                <button class="btn btn_panel">
                    ...
                    <a class="panel_p" href="/pages/profile">Главная</a>
        ...
        <div class="header">
            <div class="header_panel">
                <h2 class="header_h2"><?= $_SESSION['user']['full_name'] ?>,<br>добро пожаловать в личный кабинет!</h2>
            ...
            <div class="header_container">
                ...
                <div class="header_block1">
                    <h3 class="header_block2_h3">Создать Техническое заключение</h3>
                    <form action="" class="header_block1_form">
                        <h3 class="form_h3">Введите № Т/з:</h3>
                        <input type="text">
                        <h3 class="form_h3">Выберите список оборудования для дефектовки:</h3>
                        <input type="file" name="filename">
                        <button class="btn_h3">Создать Т/З</button>
                    </form>
                </div>
                <!--
                <div class="header_block2">
                    <h3 class="header_block2_h3">Проверить статус выполнения Т/з</h3>
                    <form action="" class="header_block1_form">
                        <h3 class="form_h3">Введите №:</h3>
                        <input type="text">

                        <button class="btn_h3">Найти в Выполненных</button>
                    </form>
                </div>
-->
                <div class="header_block3">
                    <h3 class="header_block2_h3">Добавить дефект к оборудованию в БД</h3>
                    <form action="" class="header_block1_form">
                        <h3 class="form_h3">Введите оборудование</h3>
                        <input type="text">
                        <h3 class="form_h3">Введите соответствующий дефект:</h3>
                        <input type="text">
                        <button class="btn_h3">Записать в Базу дефектов</button>
                    </form>
                </div>
            </div>
        </div>
