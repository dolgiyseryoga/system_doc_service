    ...
    <div class="container">
        ...
        <div class="header">
            <div class="header_panel">
                <h2 class="header_h2"><?= $_SESSION['user']['full_name'] ?>,<br>добро пожаловать в раздел инструкций!</h2>
                <h3 class="header_h3">Связаться с нами:<br>mail@mail.com</h3>
            </div>

            <h3 class="manual_h3">Данный сервис помогает ускорить процесс создания технических заключений и др. видов документооборота. </h3>

            <span class="manual_span">Чтобы сформировать Техническое Заключение о непригодности техники, для дальнейшего её списания (далее Т/З), нужно:</span>

            <p class="manual_p"> 1. Перейти на главную страницу Личного кабинета. В разделе "Создать Техническое заключение" ввести номер документа.<br>
                2. Загрузить из файла список (заявку) на Т/З.<br>
                3. Нажать на кнопку "Создать Т/З".<br>
                Сформированный готовый документ скачается автоматически!</p>


            <br>


            <h3 class="manual_h3"> База дефектов самообучаема. Вы можете добавить отсутствующее оборудование и дефект самостоятельно. И сервис будет использовать Ваши "дефекты" и "оборудование" при формировании Т/З.</h3>

            <br><br><span class="manual_span"> Чтобы добавить неисправность в базу дефектов оборудования нужно:</span>

            <p class="manual_p"> 1. Перейти на главную страницу Личного кабинета. В разделе "Добавить дефект к оборудованию в БД " ввести оборудование.<br>
                2. Добавить соответствующий дефект.<br>
                3. Нажать на кнопку Записать в базу дефектов" </p>
